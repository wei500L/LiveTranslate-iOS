...
enum ErrandDateParser {
    ...
    private static let ruWeekdays: [String: Int] = [
        "понедельник": 2, "понедельника": 2,
        "вторник": 3, "вторника": 3,
        "среду": 4, "среда": 4, "среды": 4,
        "четверг": 5, "четверга": 5,
        "пятницу": 6, "пятница": 6, "пятницы": 6,
        "субботу": 7, "суббота": 7, "субботы": 7,
        "воскресенье": 1, "воскресенья": 1
    ]
